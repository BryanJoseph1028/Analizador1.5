...
public class Interfaz extends javax.swing.JFrame {
   ...
   String cabecera1[]={"No."," Token "," Tipo"};
    ...
    private void initComponents() {
        ...
        txtBTexto = new javax.swing.JEditorPane();
        jButtonTraductor = new javax.swing.JButton();
        ...
        txtBTexto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtBTextoKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtBTextoKeyReleased(evt);
            }
        });

        jButtonTraductor.setText("Tracucir");
        jButtonTraductor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonTraductorActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(81, 81, 81)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtBTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 607, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(33, 33, 33))))
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addContainerGap())
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtBTexto, javax.swing.GroupLayout.DEFAULT_SIZE, 629, Short.MAX_VALUE)
                                .addContainerGap())))))
        );
...
//r.put("==", 0);
        ...
        while (itr.hasNext()) {
            token = itr.next();
            if (r.get(token) > 0) {
                model.addRow(new Object[]{token, r.get(token), "Reservada"});
            }
        }
        ...
        while (itr.hasNext()) {
            token = itr.next();
            if (Igualque.get(token) > 0) {
                model.addRow(new Object[]{token, Igualque.get(token), "SigIgualdad"});
            }
        }
        ...
        while (itr.hasNext()) {
            token = itr.next();
            if (simbol.get(token) > 0) {
                model.addRow(new Object[]{token, simbol.get(token), "simbolo"});
            }
        }
        ...
        while (itr.hasNext()) {
            ...
            if (num.get(token) > 0) {
                ...
                if (token.matches("[0-9]+.[0-9]+")) {
                    model.addRow(new Object[]{token, num.get(token), "N.Decimal"});
                }
            }
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (txtATexto1.getText().matches(main)) {
            while (st.hasMoreTokens()) {
                ...
                if (token.matches(it4)) {
                    it++;
                }
                if (token.matches(it5)) {
                    it--;
                }
    ...
    private void txtBTextoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBTextoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBTextoKeyPressed

    private void txtBTextoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBTextoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBTextoKeyReleased

    private void jButtonTraductorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTraductorActionPerformed
        // TODO add your handling code here:
        /////////////////////////// generacion de tabla/////////////////////////////
        HashMap<String, Integer> r = new HashMap<>();
        HashMap<String, Integer> op = new HashMap<>();
        ...
        HashMap<String, Integer> librerias = new HashMap<>();
...
//r.put("==", 0);
        ...
        librerias.put("#include stdafx.h",5);
        //librerias.put("#include string", 0);
        ...
        StringTokenizer st = new StringTokenizer(txtATexto1.getText(), "@#$&!?¡¿{}();,\"+-*/><||&&#¡= \n\t", true);    
        String token="",lastToken = "", text = "", c = "", cmas = "";
        ...
        while (st.hasMoreTokens()) {
            ...
            if (ignorar == true && lastToken == ";") {
                ignorar = false;
            }
            
            if (!" ".equals(token) && !"\n".equals(token) && !"\t".equals(token) && ignorar == false) {
                if (r.containsKey(token)) { 
                    ...
                    switch (token) {
                        ...
                        case "String":
                            ...
                            if (!(librerias.containsKey("#include string"))) {
                               // librerias.put("#include string", librerias.get("#include string") + 2);
                            librerias.put("#include string", 1);
                            }
...
//                                    }
       ...
       Iterator<String> itr = librerias.keySet().iterator();
        while (itr.hasNext()) {
            token = itr.next();
            
            if (librerias.get(token) > 0) {
                cmas = token + "\n" + cmas;
            }
        }
        
        
        txtBTexto.setText(cmas);
...
//        }
        ...
        //jTable2.setModel(model);
        ////////////////////////////////////////////////////////////////////////////
    }//GEN-LAST:event_jButtonTraductorActionPerformed
...
//                       ResOperador=ResOperador+""+token+"\n";
    ...
    private javax.swing.JButton jButtonTraductor;
    ...
    private javax.swing.JEditorPane txtBTexto;
